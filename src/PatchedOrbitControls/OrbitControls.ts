...
var OrbitControls = function (object, domElement) {
  ...
  this.update = (function () {
    ...
    var quatInverse = quat.clone().inverse() // quat.clone().invert()
    ...
    return function update() {
      var position = scope.object.position || new Vector3()
      ...
      scope.object.lookAt?.(scope.target || new Vector3())
      ...
      if (
        zoomChanged ||
        lastPosition.distanceToSquared(scope.object.position || new Vector3()) >
          EPS ||
        8 *
          (1 -
            lastQuaternion.dot(scope.object.quaternion || new Quaternion())) >
          EPS
      ) {
        scope.dispatchEvent(changeEvent)

        lastPosition.copy(scope.object.position || new Vector3())
        lastQuaternion.copy(scope.object.quaternion || new Quaternion())
        zoomChanged = false
        zoomFactor = 1
  ...
  var pan = (function () {
    ...
    return function pan(deltaX, deltaY) {
      ...
      console.log(this, scope, scope.object)
